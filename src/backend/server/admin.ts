...
const driverConfigs: Record<string, any> = {
  ...
  WebDav: {
    ...
    common: COMMON_FIELDS,
    additional: [
      { name: "address", type: "string", default: "", required: true },
      { name: "username", type: "string", default: "", required: true },
      { name: "password", type: "string", default: "", required: true },
      { name: "root_folder_path", type: "string", default: "/", required: false },
      { name: "tls_insecure_skip_verify", type: "bool", default: false, required: false },
    ],
    config: {
      name: "WebDav",
      local_sort: true,
  ...
  S3: {
    ...
    additional: [
      ...
      { name: "session_token", type: "string", default: "", required: false },
      { name: "bucket", type: "string", default: "", required: true },
      { name: "root_folder_path", type: "string", default: "/", required: false },
      { name: "force_path_style", type: "bool", default: false, required: false },
      { name: "sign_url_expire", type: "number", default: "3600", required: false },
      { name: "custom_host", type: "string", default: "", required: false },
      { name: "enable_custom_host_presign", type: "bool", default: false, required: false },
      { name: "remove_bucket", type: "bool", default: false, required: false },
      { name: "list_object_version", type: "select", options: "v1,v2", default: "v2", required: false },
      { name: "add_filename_to_disposition", type: "bool", default: false, required: false },
    ],
    config: {
      name: "S3",
      local_sort: true,
